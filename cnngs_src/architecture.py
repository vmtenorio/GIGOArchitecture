"""
The code here is mainly provided by Michäel Defferrard
https://github.com/mdeff/cnn_graph

Modifications have been included to acommodate for Selection and Aggregation
GNN architectures.
"""
...
#        print('  architecture/S = {}'.format(S))
    ...
    def modify_S_SP(self, S_new):
        ### Create list of S for lsigfs of selection.
        S = []
        for i in range(len(self.K)):
            thisS = gt.GSO_powers_selected(S_new,self.N[i],self.K[i])
            S = S + [thisS]
        self.S = S
        self.build_graph(self.N[0])
